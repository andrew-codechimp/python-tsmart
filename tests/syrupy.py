...
class TSmartSnapshotSerializer(AmberDataSerializer):
    """TSmart snapshot serializer for Syrupy.

    Handles special cases for TSmart data structures.
    """
...
class TSmartSnapshotExtension(AmberSnapshotExtension):
    """TSmart extension for Syrupy."""

    VERSION = "1"
    """Current version of serialization format.

    Need to be bumped when we change the TSmartSnapshotSerializer.
    """

    serializer_class: type[AmberDataSerializer] = TSmartSnapshotSerializer
